...
def main():
    ...
    if all_checks_passed:
        ...
        print()
        print("  1. Install/refresh dependencies (incl. pysc2) with uv:")
        print("     uv sync")
        print("     (then run scripts via 'uv run python ...')")
        print()
        print("  2. Install StarCraft II:")
        print("     https://starcraft2.com/")
        print()
        print("  3. Set SC2 path (if installed in custom location):")
